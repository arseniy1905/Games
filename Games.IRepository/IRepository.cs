using Games.IRepository.Query;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Linq.Expressions;

namespace Games.IRepository
{
    public interface IRepository<TModel> : IQueryable<TModel> where TModel : class
    {
        ...
        //IQueryable<TModel> ThenInclude<TPreviousProperty, TProperty>(Expression<Func<TPreviousProperty, TProperty>> navigationPropertyPath);
