...
{
    public class OrderItemSKUDetail
    {
        public long Id { get; set; }
        public long OrderId { get; set; }
        public long OrderItemId { get; set; }
        public OrderItemDetail OrderItemDetailInfo { get; set; }
        public long TempOrderItemSKUDetailID { get; set; }
        ...
        public string WHUnitOfMeasure { get; set; }
