...
namespace Games.Common.Extensions
{
    ...
    {
        /// <summary>
        /// Load the  <see cref="System.Type"/> from the base directory of the current domain using full type name as a <see cref="System.String"/>.
        /// (Includes assembly name) .
        /// This extension is mostly used to get the <see cref="System.Type"/> which is not referenced in the current project (dll,exe),
